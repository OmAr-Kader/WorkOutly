...
data class Theme(
    ...
    val textColor: Color,
    val textForGradientColor: Color,
...
fun generateTheme(isDarkMode: Boolean): Theme {
    return if (isDarkMode) {
        Theme(
            ...
            gradientColor = Color(0xFF265160),
            gradientSec = Color(0xFF265160).darken(0.5F),
            ...
            textForGradientColor = Color(red = 204, green = 204, blue = 204),
        ...
        Theme(
            ...
            gradientColor = Color(0xFF265160),
            gradientSec = Color(0xFF265160).lighten(0.5F),
            ...
            textForGradientColor = Color.White,
            textForPrimaryColor = Color.Black,
